        ...
        <div class="widget">
            ...
            <div class="widget widget-table action-table">
                ...
                <div class="widget-content">
                    {{ Form::model($document,['route' => ['documents.update',$document->id], 'method'=>'patch','class'=>'form-horizontal']); }}
                    <fieldset>
                        <br />
                        ...
                        <div class="controls">
                            ...
                            <label class="checkbox list-group">
                                <label class="checkbox list-group">
                                    <input type="checkbox" name="units[]" value="{{ $id }}" <?php if(in_array($id,$document->unitList)) echo "checked='checked'"; ?> />{{ $name }}
                                </label>
                            </label>
                            @endforeach
                        </div><!-- /controls -->
